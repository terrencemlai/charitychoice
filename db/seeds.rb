...
teachers = [{ full_name: 'Dana Demo', honorific: 'Ms.', teacher_name: 'Teacher'},
            { full_name: 'Lino Stumpff', honorific: 'Ms.', teacher_name: 'Stumpff' },
...
donors = [  { full_name: 'Dana Donor', last_name: 'Donor' },
            { full_name: 'Ngoc Kingsley', last_name: 'Kingsley' },
...
categories = [  { category: 'Computer Science', group: 'subject'},
                ...
                { category: 'Reading Nooks & Desks', group: 'need'},
